...
_$ParametersImpl _$$ParametersImplFromJson(Map<String, dynamic> json) => _$ParametersImpl(
      intensities:
          (json['intensities'] as List<dynamic>?)?.map((e) => (e as num).toInt()).toList() ??
              const [],
...
Map<String, dynamic> _$$ParametersImplToJson(_$ParametersImpl instance) => <String, dynamic>{
