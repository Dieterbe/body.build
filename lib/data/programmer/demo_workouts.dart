...
// Create demo workout with version 1, then migrate to current version
final demo1 = _createDemo1().migrate(1);

ProgramState _createDemo1() {
  return ProgramState(
      ...
      Workout(
        ...
        setGroups: [
          ...
          SetGroup([
            ...
            Sets(
              1,
              ex: _ex('tricep extension'),
              tweakOptions: {'loading': 'dumbbell', 'posture': 'standing'},
            ),
        ...
        setGroups: [
          SetGroup([
            Sets(
              ...
              tweakOptions: {'bar placement': 'front', 'lower leg movement': 'back and forth'},
            ),
          ...
          SetGroup([
            ...
            Sets(
              2,
              n: 2,
              ex: _ex('standing cable bicep curl'),
            ...
            Sets(
              ...
              n: 2,
              ex: _ex('tricep extension'),
              tweakOptions: {'loading': 'cable', 'posture': 'standing'},
            ),
