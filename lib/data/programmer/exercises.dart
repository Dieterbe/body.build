...
final List<Ex> exes = [
  ...
  Ex(EBase.legCurlHipExtended, "bodyweight leg curl with trx", [Equipment.trx],
      [legCurlAnkleDorsiflexed, legCurlHipFlexion]),
  Ex(EBase.legCurlHipExtended, "bodyweight leg curl with rings",
      [Equipment.gymnasticRings], [legCurlAnkleDorsiflexed, legCurlHipFlexion]),
  Ex(EBase.legCurlHipExtended, "nordic curl", [],
      [legCurlAnkleDorsiflexed, legCurlHipFlexion]),
  ...
  Ex(EBase.squatSissy, "sissy squat", [], [legExtensionLean]),
  Ex(EBase.squatSissyAssisted, "assisted sissy squat", [], [legExtensionLean]),
