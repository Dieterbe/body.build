    ...
    return Container(
      ...
      child: Column(
        children: [
                  ...
                  children: [
                    AddSetButton(() async {
                      ...
                      await Posthog().capture(
                        ...
                        properties: {'muscle': 'any', 'setgroups': workout.setGroups.length},
                      );
          ...
          BuilderWorkoutSetsHeader(workout, setup, onChange: onChange),
          ...
          return DragTargetWidget(
            ...
            onDrop: (Sets sNew) => workout.copyWith(
              setGroups: workout.setGroups
                  .map((e) => (e == sg) ? e.copyWith(sets: [...e.sets, sNew]) : e)
                  .toList(),
            ),
  ...
  return Container(
    ...
    child: Stack(
      children: [
        const RotatedBox(
          quarterTurns: 1,
          child: Text('COMBO', style: TextStyle(fontSize: 12.0, fontWeight: FontWeight.bold)),
        ),
        Column(
          children: sg.sets
              .mapIndexed<Widget>(
